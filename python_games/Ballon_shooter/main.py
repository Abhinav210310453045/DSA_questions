...
font = pygame.font.SysFont("Arial", 25) # takes in the name of the font and size of the font, it is used to store the font that will be used to display the score of the user
...
def pointer():
    ...
    pygame.draw.line(display,color,(pos[0],pos[1]-1/2),(pos[0],pos[1]-1),4)
    pygame.draw.line(display,color,(pos[0]+1/2,pos[1]),(pos[0]+1,pos[1]),4)
    pygame.draw.line(display,color,(pos[0],pos[1]+1/2),(pos[0],pos[1]+1),4)
    pygame.draw.line(display,color,(pos[0]-1/2,pos[1]),(pos[0]-1,pos[1]),4)
def lowerPlatform():
...
def showScore():
    scoreText=font.render("Ballons Bursted : "+ str(score),True,white)
